...
let todos: TodoItem[] = [
    ...
    new TodoItem(2, "Clean bedroom"),
    new TodoItem(3, "Practice piano"),
    new TodoItem(4, "Play MineCraft", true)
];

let collection: TodoCollection = new TodoCollection("Aaron", todos);
